...
const LandingPage = ({
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-950 text-slate-900 dark:text-white selection:bg-blue-100 dark:selection:bg-blue-900 transition-colors duration-300">
          ...
          <div className="flex flex-col gap-12 lg:gap-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <h1 className="text-5xl lg:text-7xl font-extrabold text-slate-900 dark:text-white leading-[1.1] mb-6 tracking-tight">
                Google Tasks on your <br className="hidden lg:block" />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600 dark:from-blue-400 dark:to-indigo-400">
                  Desktop
                </span>
              </h1>
              <p className="text-xl text-slate-600 dark:text-slate-300 mb-8 max-w-2xl mx-auto leading-relaxed">
                Experience the clean, focused task management you love. Install
                as a native app on Windows, macOS, or Linux directly from your
                browser.
              </p>
              <div className="flex flex-col sm:flex-row items-center gap-4 justify-center mb-16">
                <button
                  onClick={() => setShowModal(true)}
                  className="px-8 py-4 bg-blue-600 hover:bg-blue-700 text-white rounded-full font-bold text-lg shadow-lg shadow-blue-200 dark:shadow-blue-900/20 hover:shadow-xl hover:translate-y-[-2px] transition-all flex items-center gap-3 w-full sm:w-auto justify-center"
                >
                  <Download size={22} />
                  Install App
                </button>
                <div className="text-xs text-slate-400 font-medium px-4">
                  v3.0.0 � PWA � All Platforms
                </div>
              </div>
            </div>
      ...
      {/* Trust Badges */}
      <section className="py-10 border-y border-slate-100 dark:border-slate-800 bg-gray-100 dark:bg-slate-900/50 transition-colors">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <p className="text-slate-500 dark:text-slate-400 font-medium mb-6">
            Trusted by productive people worldwide
          </p>
          <div className="flex flex-wrap justify-center gap-8 md:gap-16 opacity-50 grayscale hover:grayscale-0 transition-all duration-500 dark:invert dark:hover:invert-0">
            <span className="text-xl font-bold text-slate-800 dark:text-blue-500">
              ACME Corp
            </span>
            <span className="text-xl font-bold text-slate-800 dark:text-blue-500">
              GlobalTech
      ...
      <section
        id="features"
        className="py-24 bg-white dark:bg-slate-950 scroll-mt-20 transition-colors"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-4">
              Native power, Web flexibility.
            </h2>
            <p className="text-lg text-slate-600 dark:text-slate-400">
              TaskFlow PWA brings the best of both worlds. Light as a website,
              powerful as a native app.
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <FeatureCard
              icon={RotateCw}
              title="Instant Sync"
              description="Changes sync instantly via Google Tasks API. Work offline and sync when you reconnect."
            />
            <FeatureCard
              icon={Layout}
              title="Standalone Window"
              description="Runs in its own window without browser chrome. Launch it from your Start Menu or Dock."
            />
            <FeatureCard
              icon={Zap}
              title="Zero Install Size"
              description="No 100MB+ installer files. The app caches instantly and takes up minimal space on your drive."
            />
            <FeatureCard
              icon={Moon}
              title="Dark Mode"
              description="Automatically matches your system theme preferences or toggle manually."
            />
            <FeatureCard
              icon={Smartphone}
              title="Cross Platform"
              description="One app works everywhere: Windows, macOS, Linux, ChromeOS, and even Android."
            />
            <FeatureCard
              icon={Menu}
              title="Full Feature Set"
              description="Subtasks, due dates, lists, and drag-and-drop organization."
            />
          </div>
        </div>
      </section>
      ...
      <section
        id="how-it-works"
        className="py-24 bg-slate-50 dark:bg-slate-900 border-y border-slate-200 dark:border-slate-800 scroll-mt-20 transition-colors relative overflow-hidden"
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center max-w-3xl mx-auto mb-20">
            ...
            <p className="text-lg text-slate-600 dark:text-slate-400 leading-relaxed">
              Forget .exe files and wizards. PWA technology makes installation
      ...
      <section
        id="pricing"
        className="py-32 bg-gray-100 dark:bg-slate-950 scroll-mt-20 transition-colors"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-20">
            <h2 className="text-4xl font-extrabold text-slate-900 dark:text-white mb-6 tracking-tight">
            ...
            <p className="text-lg text-slate-600 dark:text-slate-400 leading-relaxed">
              TaskFlow PWA is open source and free to use. Upgrade for advanced
